...
const githubService = {
    ...
    async fetchAndCalculateHIndex(searchTerm, dateLimit, property, sortParam, githubToken) {
        ...
        if (githubToken) {
            return this.fetchAndCalculateHIndexGraphQL(searchTerm, dateLimit, property, githubToken);
        } else {
            return this.fetchAndCalculateHIndexREST(searchTerm, dateLimit, property, sortParam);
        }
    },
     ...
     * @returns {Object} - Object containing H-Index, repositories, and fetch details
     */
    async fetchAndCalculateHIndexGraphQL(searchTerm, dateLimit, property, githubToken) {
     ...
     * @returns {Object} - Object containing H-Index, repositories, and fetch details
     */
    async fetchAndCalculateHIndexREST(searchTerm, dateLimit, property, sortParam) {
        let repos = [];
        let page = 1;
        let currentHIndex = 0;
     ...
     */
    async getMetricsWithGraphQL(searchTerm, dateLimit, githubToken) {
        if (!githubToken) {
